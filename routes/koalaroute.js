...
// // const AVIASALES_API =
// // "https://api.travelpayouts.com/aviasales/v3/prices_for_dates"; // This is an original one have access the flights names , and the price but only one
// // "https://api.travelpayouts.com/aviasales/v3/get_latest_prices";

// //  This is another update
// const AVIASALES_API = "https://api.travelpayouts.com/v1/flight_search";
...
// //     const flightsWithTotalPrice = (data.data || []).map((flight) => ({
// //       ...flight,
// //       price: flight.price * passengers,
// //     }));

// //     res.json({ data: flightsWithTotalPrice });
// //   } catch (err) {
...
//     const requestData = {
//       signature: "your_calculated_signature", // You need to implement signature generation
//       marker: process.env.AVIASALES_MARKER, // Your partner marker
//       host: req.headers.host || "yourdomain.com",
//       user_ip: req.ip || req.connection.remoteAddress,
//       locale: "en",
//       trip_class: "Y", // Economy class
//       passengers: {
...
//     // Initialize search
//     const searchResponse = await fetch(AVIASALES_API, {
//       method: "POST",
//       headers: {
...
//         error: searchData.error || "Aviasales API request failed",
//       });
//     }
...
//       if (resultsData.length > 0 && !resultsData[0].search_id) {
//         results = resultsData;
//       }
//     }

//     if (!results) {
//       return res.status(408).json({ error: "Flight search timeout" });
//     }
